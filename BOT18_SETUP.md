...
**Your API Key (Bot-18):** `8S26lZP4WqBe-6auoXCnk0RNZtg3SkSus5LTc5qfY5g`
...
curl -s https://bridge.agustinynatalia.site/v1/inbox/18 \
  -H "X-API-Key: 8S26lZP4WqBe-6auoXCnk0RNZtg3SkSus5LTc5qfY5g" \
  | python3 -m json.tool
```
...
HEADERS = {"X-API-Key": "8S26lZP4WqBe-6auoXCnk0RNZtg3SkSus5LTc5qfY5g"}
